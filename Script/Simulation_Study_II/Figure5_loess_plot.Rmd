...
##!!
dat <- read.csv(paste0("Synthetic_count_data_200_GGM_", seed,".csv")) 
...
##!!
dat <- read.csv(paste0("Synthetic_count_data_400_GGM_", seed,".csv")) 
FPdata <- semi_join(dat, negative, by = c("row", "col"))
FNdata <- semi_join(dat, positive, by = c("row", "col"))
...
##!!
dat <- read.csv(paste0("Synthetic_count_data_600_GGM_", seed,".csv")) 
FPdata <- semi_join(dat, negative, by = c("row", "col"))
FNdata <- semi_join(dat, positive, by = c("row", "col"))
...
##!!
dat <- read.csv(paste0("Synthetic_count_data_800_GGM_", seed,".csv")) 
FPdata <- semi_join(dat, negative, by = c("row", "col"))
FNdata <- semi_join(dat, positive, by = c("row", "col"))
...
##!!
dat <- read.csv(paste0("Synthetic_count_data_1000_GGM_", seed,".csv")) 
FPdata <- semi_join(dat, negative, by = c("row", "col"))
FNdata <- semi_join(dat, positive, by = c("row", "col"))
