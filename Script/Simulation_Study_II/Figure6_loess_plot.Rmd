...
FP_skew <- vector("list", 50)
FP_kurt <- vector("list", 50)
FN_skew <- vector("list", 50)
FN_kurt <- vector("list", 50)
...
##!!
dat <- read.csv(paste0("Synthetic_count_data_200_Ridge", seed,".csv")) 
...
##!!
dat <- read.csv(paste0("Synthetic_count_data_400_Ridge", seed, ".csv")) 
FPdata <- semi_join(dat, negative, by = c("row", "col"))
FNdata <- semi_join(dat, positive, by = c("row", "col"))
...
##!!
dat <- read.csv(paste0("Synthetic_count_data_600_Ridge", seed, ".csv")) 
FPdata <- semi_join(dat, negative, by = c("row", "col"))
FNdata <- semi_join(dat, positive, by = c("row", "col"))
...
##!!
dat <- read.csv(paste0("Synthetic_count_data_800_Ridge", seed, ".csv")) 
FPdata <- semi_join(dat, negative, by = c("row", "col"))
FNdata <- semi_join(dat, positive, by = c("row", "col"))
...
##!!
dat <- read.csv(paste0("Synthetic_count_data_1000_Ridge", seed, ".csv")) 
FPdata <- semi_join(dat, negative, by = c("row", "col"))
FNdata <- semi_join(dat, positive, by = c("row", "col"))
